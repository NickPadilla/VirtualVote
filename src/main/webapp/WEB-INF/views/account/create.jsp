...
<body>
   <div align="center">
		<form:form modelAttribute="account" action="save" method="post">
			<fieldset>
				<%-- show all errors in one tag.. - specify element to put them in - uses span by default
				<form:errors path="*" cssClass="errorblock" element="div" /> --%>
				<!-- hidden fields that are needed when going back to the server -->
				<form:hidden id="id" path="id"/>
				<form:hidden id="roles" path="roles"/>
				<form:hidden id="person.id" path="person.id"/>
				<form:hidden id="login.id" path="login.id"/>
		    	<p>
				...
				<p>
					...
					<form:password showPassword="true" id="login.password" path="login.password" autocomplete="on" size="50" style="font-size: 20px" />
					<br/>
				...
				<p>
					...
					<form:password showPassword="true" id="login.passwordVerify" path="login.passwordVerify" autocomplete="on" size="50" style="font-size: 20px" />
					<br/>
				...
				<input id="create" value="<spring:message code="label.save" />" type="submit" />
			    <br/>
			    <a id="index" href="<c:url value="/" />"><spring:message code="label.cancel"/></a>
			    <br/>
			</fieldset>
		</form:form>
	</div>	
